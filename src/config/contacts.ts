...
export const CONTACTS = {
  CURSOS:    "573167405680",   // Coordinación de Cursos Cortos
...
// Siempre usar encodeURIComponent() al insertar en URLs
// ─────────────────────────────────────────────────────────────────────────────

export const WA_MESSAGES = {
  // Formulario de inscripción — incluye datos del usuario
  ...
  // Selector de sede en programas (WhatsAppSelector)
