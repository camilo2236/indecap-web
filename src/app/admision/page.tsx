    ...
    return (
      <main className="min-h-screen flex items-center justify-center px-4" style={{ background: "linear-gradient(135deg,#0f0c2e 0%,#1a086e 100%)" }}>
        <div className="bg-white rounded-3xl p-10 max-w-md w-full text-center shadow-2xl">
          ...
          <a
            href="https://wa.me/573167405680?text=Hola%2C%20acabo%20de%20solicitar%20información%20sobre%20INDECAP"
            target="_blank"
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white rounded-3xl p-7 shadow-2xl">
          ...
          <div className="mt-5 pt-5 border-t border-[#f3f4f6] text-center">
            <a
              href="https://wa.me/573167405680?text=Hola%20INDECAP%2C%20quiero%20información%20sobre%20sus%20programas"
              target="_blank"
              rel="noopener noreferrer"
