  ...
  try {
            ...
            <tr><td align="center">
              <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                ...
                <tr><td style="padding:24px 40px;">
                  <span style="display:inline-block;background:#FEF3C7;color:#92400E;font-size:11px;font-weight:700;padding:6px 16px;border-radius:99px;text-transform:uppercase;">📋 Admisión — ${valorMatricula}</span>
                  <h2 style="margin:16px 0 20px;color:#080F14;font-size:20px;">${s.nombres} ${s.apellidos}</h2>

                  ${seccion("Datos del Aspirante")}
                  <table width="100%" cellpadding="0" cellspacing="0">
                    ${fila("Cédula/TI", s.cedula)}
                    ${fila("Fecha nacimiento", s.fechaNac)}
                    ${fila("Dirección", [s.direccion, s.barrio, s.municipio].filter(Boolean).join(", "))}
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
                    ...
                    ${fila("Último grado", s.ultimoGrado)}
                    ${fila("Cómo se enteró", s.comoSeEntero)}
                    ${fila("Valor matrícula", valorMatricula)}
                  </table>
    ...
    if (s.correo) {
      await resend.emails.send({
        ...
        to: [s.correo],
        subject: `✅ Solicitud de admisión recibida — INDECAP ${s.sede}`,
        html: `
          <!DOCTYPE html><html><head><meta charset="utf-8"></head>
          <body style="margin:0;padding:0;background:#F3F8FA;font-family:'Helvetica Neue',Arial,sans-serif;">
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#F3F8FA;padding:40px 20px;">
              <tr><td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                  ...
                  <tr><td style="padding:36px 40px;text-align:center;">
                    ...
                    <div style="background:#FEF3C7;border:1px solid #F0A500;border-radius:12px;padding:20px;text-align:center;margin-bottom:24px;">
                      ...
                      <p style="margin:0;color:#92400E;font-size:12px;line-height:1.5;">
                        Realiza el pago a través de <a href="https://www.avalpaycenter.com/wps/portal/portal-de-pagos/web/pagos-aval/resultado-busqueda/realizar-pago?idConv=00003179&origen=buscar" style="color:#92400E;font-weight:700;">Aval Pay</a> o en la sede con el QR de Davivienda.
                      </p>
                    </div>` : `
                    ...
                    <p style="margin:0 0 20px;color:#6B7280;font-size:13px;line-height:1.6;">Un asesor INDECAP te contactará pronto para confirmar tu cupo.</p>
                  ...
                  <tr><td style="background:#F8FAFC;padding:16px 40px;text-align:center;border-top:1px solid #E5E7EB;">
                    <p style="margin:0;color:#9CA3AF;font-size:11px;">Corporación Educativa INDECAP · (604) 448 4794 · indecap@indecap.edu.co</p>
                  </td></tr>
                </table>
              </td></tr>
            </table>
