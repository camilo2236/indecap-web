        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="mt-5 flex gap-4 font-[family-name:var(--font-dm-sans)]">
              <a
                href="https://www.facebook.com/indecapedu/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-white/60 transition-colors hover:text-[#FACC15]"
              >
                Facebook
              </a>
              <a
                href="https://www.instagram.com/instindecap/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-white/60 transition-colors hover:text-[#FACC15]"
              >
              ...
              <a
                href="https://www.youtube.com/channel/UCDqQs0jzf-Zy-nsCBFnLmEA"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-white/60 transition-colors hover:text-[#FACC15]"
              >
            ...
            <div key={location.id}>
              ...
              <ul className="mt-3 space-y-2 font-[family-name:var(--font-dm-sans)] text-sm text-white/70">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <a href="tel:+576044484794" className="hover:text-white">
                    {location.phone}
                  </a>
                </li>
                <li className="flex items-center gap-2">
